...
from hippo.core.loaders.base import EntityLoader, IngestResult
...
class IngestPipeline:
    ...
    1. transform() maps raw source data to Hippo fields
    ...
    hippo.core.ingestion. It works with any EntityLoader subclass.
    """
