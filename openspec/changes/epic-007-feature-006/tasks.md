...
- [x] 1.1 Review existing CLI structure for schema commands
- [x] 1.2 Define command-line interface for compile-schema command
- [x] 1.3 Define command-line interface for validate command  
- [x] 1.4 Define command-line interface for schema diff command
- [x] 1.5 Set up test environment for CLI commands
...
- [x] 5.1 Verify all acceptance criteria are met
- [x] 5.2 Run full test suite to ensure no regressions
- [x] 5.3 Test edge cases and error conditions
- [x] 5.4 Confirm CLI commands work with various input types